...
export function ProductSearchCard({ product }: { product: MockProduct }) {
    return (
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden group hover:shadow-md transition-all flex flex-col h-full">
