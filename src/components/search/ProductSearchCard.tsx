...
export function ProductSearchCard({ product }: { product: ProductSearchCardProduct }) {
    ...
    return (
        <Link href={`/product/${product.id}`} className="block group">
            <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 overflow-hidden hover:shadow-md transition-all flex flex-col h-full cursor-pointer">
                ...
                <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="pt-4 border-t border-zinc-100 flex items-center gap-3 mb-6">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex items-center gap-1.5 font-medium text-sm text-zinc-900">
