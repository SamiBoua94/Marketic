...
import { Package, Calendar, Truck, CheckCircle, Clock, XCircle, ArrowRight, Eye, Edit2, Save, X, User, MapPin, Phone } from 'lucide-react';
...
export default function ShopOrdersPage() {
            ...
            try {
                ...
                if (!response.ok) {
                    if (response.status === 404) {
                        setError('Vous n\'avez pas de boutique ou votre boutique n\'est pas configurée');
                    } else {
    ...
    if (!user) {
        return (
            <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center text-center">
                ...
                <h1 className="text-3xl font-bold text-foreground mb-4">Connectez-vous pour gérer vos commandes</h1>
                <p className="text-foreground/60 max-w-md mb-8">
                    Vous devez être connecté pour consulter les commandes de votre boutique.
                </p>
                <Link href="/login">
        ...
        return (
            <div className="container mx-auto px-4 py-20 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-foreground/60">Chargement des commandes de votre boutique...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-6xl">
            <div className="mb-8">
                <h1 className="text-4xl font-bold text-foreground mb-2">Commandes de ma boutique</h1>
            ...
            {orders.length === 0 ? (
                <div className="text-center py-20">
                    ...
                    <p className="text-foreground/60 mb-8 max-w-md mx-auto">
                        Vous n'avez pas encore reçu de commande pour vos produits. Vos commandes apparaîtront ici dès que les clients commenceront à acheter.
                    </p>
                    <Link href="/shop">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="bg-secondary/5 rounded-lg p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="font-medium">{selectedOrder.shippingInfo.fullName}</span>
                                    </div>
                                    ...
                                    {selectedOrder.shippingInfo.phone && (
                                        <div className="flex items-center gap-2 mt-2">
                                            ...
                                            <span className="text-foreground/60">{selectedOrder.shippingInfo.phone}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
